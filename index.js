const contentLetterSrart_actived = "Chúc mừng sinh nhật Người Đẹp nhoa hãy nhấn vô hình hộp quà đi." //Lời mở đầu cho bức thư
const mainContentLetter = "Chúc em mỗi ngày đều rạng rỡ như ánh mặt trời, vui vẻ như cá gặp nước, và hạnh phúc như khi có anh bên cạnh. Dù thế giới có xoay vần ra sao, anh vẫn luôn là fan cứng số một của em! I LOVE YOU❤️" //Nội dung của bức thư
...
imgLetter.src = "8.png"; //Hình ảnh xuất hiện trong nội dung của bức thư sau khi bức thư được viết ra hết
